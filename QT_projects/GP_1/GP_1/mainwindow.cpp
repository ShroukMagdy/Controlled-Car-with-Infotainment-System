...
void MainWindow:: Move_Stop (){
    ...
    digitalWrite(MOTOR_ID1_PIN0,LOW);
    digitalWrite(MOTOR_ID1_PIN1,LOW);
     ui->pushButton_Forward->setChecked(false);
     ui->pushButton_Backward->setChecked(false);
...
void MainWindow::keyPressEvent(QKeyEvent *e) {
    ...
    if (e->key()==Qt::Key_W){
        ...
        ui->pushButton_Forward->setFocus();
        Move_Forward ();
    }
    else if (e->key()==Qt::Key_S){
        timer->start(150);
        ui->pushButton_Backward->setChecked(true);
        ui->pushButton_Backward->setFocus();
        Move_Backward ();
    }
