    ...
    ui(new Ui::MainWindow)
{
    ...
    Myplaylist->addMedia(QUrl::fromLocalFile("/home/pi/Infotainment_Camera_V1/Merging_3_Features/Media/Music/mzmar_el3sfor.mp3"));
    ...
    //ui->DayComboBox->setStyleSheet("combobox-popup: 0");
    //ui->MonthComboBox->setStyleSheet("combobox-popup: 0");
    //ui->Minutes_ComboBox->setStyleSheet("combobox-popup: 0");

   // ui->DayComboBox->setPalette( QPalette( Qt::white ) );

  // ui->DayComboBox(textRole : "displayLabel");

    // ui->Minutes_ComboBox->setStyleSheet("combobox-popup: 0");
    //ui->Minutes_ComboBox->setStyleSheet("QComboBox { background-color: yellow; }");
...
/*void MainWindow::HomeW_CameraBtn_clicked()
{
...
void MainWindow::CameraUpdate()
{
    ...
    else if(digitalRead(0)==1 && CameraLastStateFlag==1)
    {
        //DO Nothing as the camera already On
        //this part might be removed and its inserted for debugging
    ...
    else if(digitalRead(0)==0 && CameraLastStateFlag==0)
    {
        //DO Nothing as the camera already Off
        //this part can be removed and its inserted for debugging
    }
